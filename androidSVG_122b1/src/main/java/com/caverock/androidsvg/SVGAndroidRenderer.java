...
//      Log.i(TAG, "render: width: " + width + ", viewportuserwidth: " + viewPortUser.width + ", height: " + height + ", viewportuserheight: " + viewPortUser.height);
      ...
      /*float _w = 0, _h = 0;
      if (viewPortUser.width > 0) {
         _w = viewPortUser.width;
      } else if (width != null) _w = width.floatValueX(this);
      if (viewPortUser.height > 0) {
         _h = viewPortUser.height;
      } else if (height != null) _h = height.floatValueY(this);*/
...
//      float  yOffset = -viewBox.minY;
      ...
      m.preTranslate(xOffset, yOffset);
//      Log.i(TAG, "calculateViewBoxTransform matrix: " + m.toString());
//      m.invert(m);
//      Log.i(TAG, "calculateViewBoxTransform matrix invert: " + m.toString());
      return m;
   }
